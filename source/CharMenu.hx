...
class CharMenu extends MusicBeatState{
    ...
    */
    ...
    override function create()
    {
        ...
        menuBG = new FlxSprite().loadGraphic(Paths.image('noColorBackground'));
        ...
        bgOverlay = new FlxSprite().loadGraphic(Paths.image('bgOverlay'));
        ...
        newArrows.frames = Paths.getSparrowAtlas('newArrows');
    ...
    override function update(elapsed:Float)
    {
        ...
        if (!alreadySelected)
        {
            ...
            if (accepted)
            {
                ...
                {   
                    //I Like the smooth usual transition.
