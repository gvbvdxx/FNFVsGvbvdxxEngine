...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		persistentUpdate = true;
		var lolThing:Int = Std.int(2.4);
		var lolOffsetX:Int = -350;
		var lolOffsetY:Int = -300;
				var stageFront:BGSprite = new BGSprite('scratchgamebg', (-900/lolThing) - lolOffsetX, (-900/lolThing) - lolOffsetY, 0.3, 0.3);
				stageFront.setGraphicSize(Std.int(stageFront.width * (8/lolThing)));
				stageFront.updateHitbox();
				add(stageFront);
				
				
				var stageFronta:BGSprite = new BGSprite('scratchgameclouds', (-900/lolThing) - lolOffsetX, (-900/lolThing) - lolOffsetY, 0.4, 0.4);
				stageFronta.setGraphicSize(Std.int(stageFronta.width * (6/lolThing)));
				stageFronta.updateHitbox();
				add(stageFronta);
				
				
				var stageFrontb:BGSprite = new BGSprite('scratchgametheme', (-800/lolThing) - lolOffsetX, (650/lolThing) - lolOffsetY, 1, 1);
				stageFrontb.setGraphicSize(Std.int(stageFrontb.width * (3/lolThing)));
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 2:
					#if PSYCH_WATERMARKS
					createCoolText(['Gvbvdxx engine by'], 15);
					#else
